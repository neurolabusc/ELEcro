...
const
  ...
  kHighShelf=8;//-HiShelf
     function FilterName (pFilterType: integer): string;
type
  TRbjEqFilter=class
  private
...
begin
  case pFilterType of
    kLowPass: result := 'LowPass';
    kHighPass: result := 'HighPass';
    kBandPassCSG: result := 'BandPassCSG';
    kBandPassCZPG: result := 'BandPassCZPG';
    kNotch: result := 'Notch';
    kAll: result := 'AllPass';
    kPeaking: result := 'Peaking';
    kLowShelf: result := 'LowShelf';
    kHighShelf: result := 'HighShelf';
    else result := 'Unknown';
  end;
end;
